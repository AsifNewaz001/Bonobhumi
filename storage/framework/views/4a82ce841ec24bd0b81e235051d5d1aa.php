    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="lg:hidden space-y-8">
            ...
            <div class="text-center">
                <img src="<?php echo e(asset('gheefire.png')); ?>" alt="ঘি তৈরির প্রক্রিয়া" class="w-full max-w-md mx-auto mb-8">
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-start space-x-4">
                        <div class="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style="background-color: #FFFBEB;">
                            <svg class="w-6 h-6" fill="url(#gradient1)" viewBox="0 0 20 20">
                                <defs>
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Hind Siliguri', sans-serif; color: #92400E;">শুধুমাত্র দেশি গরু</h3>
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Hind Siliguri', sans-serif; color: #92400E;">A2 বিটা-কেসিন প্রোটিন</h3>
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Hind Siliguri', sans-serif; color: #92400E;">সার্বিক স্বাস্থ্যের উন্নতি</h3>
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Hind Siliguri', sans-serif; color: #92400E;">ঐতিহ্যবাহী বিলোনা পদ্ধতি</h3>
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Hind Siliguri', sans-serif; color: #92400E;">সহজপাচ্য ও স্বাস্থ্যকর</h3>
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Hind Siliguri', sans-serif; color: #92400E;">ভিটামিন ও ওমেগা-৩ সমৃদ্ধ</h3>
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2" style="font-family: 'Hind Siliguri', sans-serif; color: #92400E;">নিবিড় যত্ন ও সেরা প্যাকেজিং</h3>
        ...
        <div class="hidden lg:block">
            <div class="grid grid-cols-3 gap-8 items-center min-h-screen">
                ...
                <div class="flex justify-center items-center h-full">
                    <img src="<?php echo e(asset('gheefire.png')); ?>" alt="ঘি তৈরির প্রক্রিয়া" class="h-full w-auto object-contain max-h-screen">
                </div>
