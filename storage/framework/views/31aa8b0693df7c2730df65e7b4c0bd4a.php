<section id="features" class="py-16 relative overflow-hidden" style="background: #ffffff;">
    ...
    <div class="lg:hidden relative z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="flex justify-center mb-4">
                <img src="<?php echo e(asset('Ghee3.png')); ?>" alt="বনভূমি A2 সরের ঘি" class="w-full max-w-sm object-contain drop-shadow-lg">
            </div>
        ...
        <div class="mt-0">
            <img src="<?php echo e(asset('model.png')); ?>" alt="Model" class="w-full h-auto object-contain object-right">
        </div>
    </div>
    ...
    <div class="hidden lg:block relative w-full h-screen overflow-hidden z-10">
        ...
        <div class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30">
            <img src="<?php echo e(asset('Ghee3.png')); ?>" alt="বনভূমি A2 সরের ঘি" class="w-[480px] h-auto object-contain">
        </div>
        
        <!-- Model Image - Bottom-Right -->
        <div class="absolute right-0 bottom-0 h-full">
            <img src="<?php echo e(asset('model.png')); ?>" alt="Model" class="h-full w-auto object-cover object-left">
        </div>
    </div>
