<section id="features" class="py-16 relative overflow-hidden" style="background: #ffffff; min-height: 100vh;">
    ...
    <div class="lg:hidden relative z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center mb-8">
                <img src="<?php echo e(asset('Ghee3.png')); ?>" alt="বনভূমি A2 সরের ঘি" class="w-full max-w-xs object-contain">
            </div>
            ...
            <div class="mt-8 -mx-4 sm:-mx-6">
                <img src="<?php echo e(asset('model.png')); ?>" alt="Model" class="w-full h-auto object-cover">
            </div>
        </div>
    </div>
    ...
    <div class="hidden lg:block relative w-full h-screen overflow-hidden z-10">
        ...
        <div class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30">
            <img src="<?php echo e(asset('Ghee3.png')); ?>" alt="বনভূমি A2 সরের ঘি" class="w-80 h-auto object-contain">
        </div>
        
        <!-- Model Image - Exact Right Edge -->
        <div class="absolute right-0 top-0 h-full">
            <img src="<?php echo e(asset('model.png')); ?>" alt="Model" class="h-full w-auto object-cover object-left" style="min-height: 100vh;">
        </div>
    </div>
