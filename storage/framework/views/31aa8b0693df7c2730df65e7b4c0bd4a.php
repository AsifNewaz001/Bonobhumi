<section id="features" class="py-16 relative overflow-hidden bg-center bg-no-repeat" style="background-image: url('<?php echo e(asset('2ndG2.png')); ?>'); background-size: cover; background-position: center;">
    
    <!-- Mobile responsive background styles -->
    <style>
        @media (max-width: 768px) {
            #features {
                background-image: url('<?php echo e(asset('M2ndSection.png')); ?>') !important;
